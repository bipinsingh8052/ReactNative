  ...
  return (
    <View style={{flex:1, justifyContent:"center", alignItems:"center"}}>
      ...
      <View style={{flexDirection:"row", gap:20, marginTop:20}}>
        <TextInput  style={{ height:20, width:20, backgroundColor:"blue", borderRadius:50, color:"black"}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"blue" ,borderRadius:50}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"blue" ,borderRadius:50}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"blue" ,borderRadius:50}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"white" ,borderRadius:50}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"white" ,borderRadius:50}}/>
        <TextInput  style={{ height:20, width:20, backgroundColor:"white" ,borderRadius:50}}/>
