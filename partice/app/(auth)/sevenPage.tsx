  ...
  return (
    <View style={{flex:1, justifyContent:"center", alignItems:"center"}}>
      ...
      <View style={{width:"100%", gap:20, padding:20, marginTop:120}}>
        <TouchableOpacity>
          <Text style={{backgroundColor:"blue", color:"white",borderRadius:20 ,textAlign:"center", paddingHorizontal:30, paddingVertical:15, fontSize:20, width:"50%"}} onPress={gotonext}>Send Again</Text>
