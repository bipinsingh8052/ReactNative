  ...
  <View style={{flex:1, justifyContent:"center", alignContent:"center", width:"100%"}}>
    ...
    <View>
      <TouchableOpacity style={{margin:20, gap:30}}>
        <Text style={{fontSize:20,backgroundColor:"blue", color:"white", textAlign:"center", paddingVertical:10, borderRadius:20}}>Done</Text>
        <Text style={{fontSize:15, color:"black", textAlign:"center", paddingVertical:10, borderRadius:20}}>cancel</Text>
      </TouchableOpacity>
    </View>
  </View>
  )
